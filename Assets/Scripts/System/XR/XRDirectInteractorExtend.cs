...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    [AddComponentMenu("XR/XR Direct Interactor Extended")]
    public class XRDirectInteractorExtend : XRBaseControllerInteractor
    {
        ...
        public override void GetValidTargets(List<XRBaseInteractable> validTargets)
        {
            ...
            for (int i = m_ValidTargets.Count - 1; i >= 0; i--)
            {
                var interactable = m_ValidTargets[i];
